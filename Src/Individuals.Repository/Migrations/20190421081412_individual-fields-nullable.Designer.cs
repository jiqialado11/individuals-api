...
namespace Individuals.Persistance.Migrations
{
    ...
    [Migration("20190421081412_individual-fields-nullable")]
    partial class individualfieldsnullable
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Individuals.Domain.Entities.City", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
            ...
            modelBuilder.Entity("Individuals.Domain.Entities.Individual", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
            ...
            modelBuilder.Entity("Individuals.Domain.Entities.Log", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
            ...
            modelBuilder.Entity("Individuals.Domain.Entities.PhoneNumber", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
            ...
            modelBuilder.Entity("Individuals.Domain.Entities.ConnectedIndividual", b =>
                {
                    b.HasOne("Individuals.Domain.Entities.Individual", "ConnectedFromIndividual")
                        .WithMany("ConnectedIndividuals")
                        .HasForeignKey("ConnectedFromIndividualId")
                        .OnDelete(DeleteBehavior.Cascade);

                    b.HasOne("Individuals.Domain.Entities.Individual", "ConnectedToIndividual")
                        .WithMany()
            ...
            modelBuilder.Entity("Individuals.Domain.Entities.Individual", b =>
                {
                    b.HasOne("Individuals.Domain.Entities.City", "City")
                        .WithMany()
            ...
            modelBuilder.Entity("Individuals.Domain.Entities.PhoneNumber", b =>
                {
                    b.HasOne("Individuals.Domain.Entities.Individual")
